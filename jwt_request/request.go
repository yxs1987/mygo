...
func ParseFromRequest(req *fasthttp.RequestCtx, extractor Extractor, keyFunc jwt.Keyfunc, options ...ParseFromRequestOption) (token *jwt.Token, err error) {
...
func ParseFromRequestWithClaims(req *fasthttp.RequestCtx, extractor Extractor, claims jwt.Claims, keyFunc jwt.Keyfunc) (token *jwt.Token, err error) {
