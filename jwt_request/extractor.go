...
type Extractor interface {
	ExtractToken(*fasthttp.RequestCtx) (string, error)
}
...
//fasthttp获取header方式跟net/http不同，分开处理
func (e HeaderExtractor) ExtractToken(req *fasthttp.RequestCtx) (string, error) {
	author := req.Request.Header.Peek(fasthttp.HeaderAuthorization)
	if len(author) > 0 {
...
func (e MultiExtractor) ExtractToken(req *fasthttp.RequestCtx) (string, error) {
...
func (e *PostExtractionFilter) ExtractToken(req *fasthttp.RequestCtx) (string, error) {
