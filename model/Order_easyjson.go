...
func easyjson4f2ebbc2DecodeMygoModel(in *jlexer.Lexer, out *PayOrder) {
...
func easyjson4f2ebbc2EncodeMygoModel(out *jwriter.Writer, in PayOrder) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v PayOrder) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
...
func (v PayOrder) MarshalEasyJSON(w *jwriter.Writer) {
	easyjson4f2ebbc2EncodeMygoModel(w, v)
}

// UnmarshalJSON supports json.Unmarshaler interface
func (v *PayOrder) UnmarshalJSON(data []byte) error {
...
func (v *PayOrder) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4f2ebbc2DecodeMygoModel(l, v)
}
func easyjson4f2ebbc2DecodeMygoModel1(in *jlexer.Lexer, out *Page) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4f2ebbc2EncodeMygoModel1(out *jwriter.Writer, in Page) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Page) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4f2ebbc2EncodeMygoModel1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Page) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4f2ebbc2DecodeMygoModel1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Page) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4f2ebbc2DecodeMygoModel1(l, v)
}
func easyjson4f2ebbc2DecodeMygoModel2(in *jlexer.Lexer, out *OrderList) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4f2ebbc2EncodeMygoModel2(out *jwriter.Writer, in OrderList) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v OrderList) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4f2ebbc2EncodeMygoModel2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *OrderList) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4f2ebbc2DecodeMygoModel2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *OrderList) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4f2ebbc2DecodeMygoModel2(l, v)
}
func easyjson4f2ebbc2DecodeMygoModel3(in *jlexer.Lexer, out *Order) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4f2ebbc2EncodeMygoModel3(out *jwriter.Writer, in Order) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Order) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4f2ebbc2EncodeMygoModel3(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Order) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4f2ebbc2DecodeMygoModel3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Order) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4f2ebbc2DecodeMygoModel3(l, v)
}
func easyjson4f2ebbc2DecodeMygoModel4(in *jlexer.Lexer, out *CreateOrder) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4f2ebbc2EncodeMygoModel4(out *jwriter.Writer, in CreateOrder) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v CreateOrder) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4f2ebbc2EncodeMygoModel4(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *CreateOrder) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson4f2ebbc2DecodeMygoModel4(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CreateOrder) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4f2ebbc2DecodeMygoModel4(l, v)
}
